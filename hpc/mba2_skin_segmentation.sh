...
find src/summary_results/results/mba/skin_segmentation* -name "*.ckpt" -delete 2>/dev/null || true
find src/summary_results/results/tuning_skin_segmentation_mba* -name "*.ckpt" -delete 2>/dev/null || true
